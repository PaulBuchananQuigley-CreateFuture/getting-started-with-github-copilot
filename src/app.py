...
activities = {
    ...
    "Music Ensemble": {
        "description": "Join our band and orchestra for weekly rehearsals and performances",
    ...
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills through formal debates",
